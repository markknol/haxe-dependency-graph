...
<head>
	...
	* { box-sizing:content-box; }
	...
	a.dep { transform:translateX(-50%) translateY(-50%); padding: 5px; position:absolute; z-index:2; border:1px solid #333; background:#fff; }
	a.dep.selected { padding:10px; border:2px solid #333; }
	a.dep:hover { z-index: 4; }
